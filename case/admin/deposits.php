...
$deposits = mysqli_query($bsd, "SELECT * FROM `deposits` ORDER BY id DESC LIMIT 20");
}
              ...
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                    <span></span>Пополнения проекта <i title="Скрипт куплен в ScriptArchive / у пользователя Enigman / Никиты Корнеева" class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle"></i>
                  </li>
                </ul>
              </nav>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Пополнения</h4>
                      </div>
<table class="table table-hover withdrawstable">
                      ...
                      <tbody>
                        <?php
                          while( ($aa = $deposits->fetch_array())){
$ue = mysqli_query($bsd, "SELECT * FROM `users` WHERE id='$aa[user_id]'");
$ue = $ue->fetch_array();
