...
$users = mysqli_query($bsd, "SELECT * FROM `users` ORDER BY id DESC");
          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> Пользователи </h3>
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                    <span></span>Пользователи проекта <i title="Скрипт куплен в ScriptArchive / у пользователя Enigman / Никиты Корнеева" class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle"></i>
                  </li>
                </ul>
              </nav>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Пользователи</h4>
                      </div>
<table class="table table-hover withdrawstable">
                      ...
                      <tbody>
                        <?php
                          while( ($ue = $users->fetch_array())){

$usname = $ue['name'];
$usava = $ue['img'];
$usbal = $ue['balance'];
$usdatareg = $ue['regdate'];


                              $pe.= "<tr>
                              <td>$ue[id]</td>
                          <td><a href=\"$ue[vk_url]\"><img src=\"$usava\" class=\"mr-2\" alt=\"image\"> $usname</a></td>
                          <td>$usbal</td>
                          <td>$usdatareg</td>
                          <td><a href=\"/admin/useredit.php?id=$ue[id]\"><button class=\"badge badge-primary\">Редактировать</button></a></td>
                        </tr>";
